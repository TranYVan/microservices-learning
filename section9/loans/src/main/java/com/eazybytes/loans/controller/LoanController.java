...
public class LoanController {
    ...
    @Autowired
    public ContactInfoDto contactInfoDto;
    ...
    public ResponseEntity<LoanDto> fetchLoanDetail(
            @RequestHeader("navyT-correlation-id") String correlationId,
    ...
    @Operation(
            ...
            description = "Get Java version that will be used for developing loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact info of the manager of loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
